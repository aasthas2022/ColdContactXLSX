...
def generate_email_address(first_name, last_name, email, company_name):
    ...
    if email:
        ...
        email1 = f"{first_name.lower()}.{last_name.lower()}@{company_name.lower()}.com"
        email2 = f"{first_name.lower()}{last_name.lower()}@{company_name.lower()}.com"
        logger.info(f"Generated email addresses: '{email1}', '{email2}'.")
